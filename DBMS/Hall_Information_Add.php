...
<div id="container">
    ...
    <div id="menu">
        <br />
        <h2>Welcome!<br><?php echo $_COOKIE["cineName"]; ?></h2>
    ...
    <div id="content">
        <form name="insert" action="Hall_Insert1.php" method="post">
            <br />
            &nbsp;
            ...
            <form name="Complete" action="Hall_Information.php" method="get">
            &nbsp;&nbsp;  &nbsp;   &nbsp;    &nbsp;           &nbsp;
