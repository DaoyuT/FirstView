...
<div id="container">
   <div id="header1">
      <a href="Customer_Interface.html"><h2 id="h1">HOME</h2></a>
   </div>
    
   <div id="header2">
      <h1 id="h2">COST ON EACH CATEGORY </h1>
   </div>
...
$stid = oci_parse($conn, 'SELECT CATEGORY, SUM(PRICE) AS SUM
...
$count=1;
echo "<br>";
echo"ACCORDING TO MOVIES YOU WATCHED, WE HAVE CALCULATED YOUR COST ON DIFFERENT MOVIE CATEGORY.";
echo "<br>";echo "<br>";
oci_fetch($stid1);
...
echo "<br>";
  ...
  echo" <img src='love.jpeg' width='2%'/>COST TOP NO $count.<br> <br>MOVIE CATEGORY: $CATEGORY <br> COST:$$SUM";
 $name=$name.$CATEGORY.'|';
  $data=$data.$SUM.'|';
     $count=$count+1;
